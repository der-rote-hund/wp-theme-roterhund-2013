...
<body id="anchor-top" <?php body_class(); ?>>
    <header>
        ...
        <h2 class="header__intro">
            <?php echo __('Hi, I\'m Philipp Marquardt, a <strong>designer gone web developer</strong>. I\'ve been designing and coding <em>standards compliant<a title="see footnote" href="#fn-1" class="fussnote-link">(*)</a></em>, <em>responsive</em> and <em>compatible</em> websites since the late nineties. In summer of 2013 I joined <a href="http://www.avency.de">avency</a> near Münster. Before that, I had formed part of a multi-disciplinary team at <a href="http://runroom.com" rel="nofollow">Runroom</a> in Barcelona for 6 &frac12; years.', 'der_rote_hund'); ?>
        </h2>
        <h3>
